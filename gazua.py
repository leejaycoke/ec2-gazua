...
class Gazua(object):
    ...
    def __init__(self):
        ...
        self.instances = {'my-aws':
            {'dev zone':
                [
                    {'tags': {'Group': 'dev zone', 'Name': 'web1'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user', 'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'web-1', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.142'},
                    {'tags': {'Group': 'dev zone', 'Name': 'web2'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user', 'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'web-2', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.143'},
                    {'tags': {'Group': 'dev zone', 'Name': 'web3'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user', 'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'web-3', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.144'},
                    {'tags': {'Group': 'dev zone', 'Name': 'ssh-proxy'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user', 'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'web-4', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.micro',
                     'private_ip': '172.31.23.144'},
                    {'tags': {'Group': 'dev zone', 'Name': 'was1'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user', 'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'was1', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.147'},
                    {'tags': {'Group': 'dev zone', 'Name': 'was2'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user', 'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'was2', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.149'}
                ],
            'database':
                [
                    {'tags': {'Group': 'dev zone', 'Name': 'web1'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user',
                     'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'master', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.142'},
                    {'tags': {'Group': 'dev zone', 'Name': 'web2'},
                     'key_name': 'hodolman',
                     ...
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.143'},
                    {'tags': {'Group': 'dev zone', 'Name': 'slave1'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user',
                     'id': 'i-0bb168b59ec98a524',
                     ...
                     'type': 't2.xlarge',
                     'private_ip': '172.31.23.144'},
                    {'tags': {'Group': 'dev zone', 'Name': 'slave2'},
                     'key_name': 'hodolman',
                     'connect_ip': '13.124.201.58',
                     'is_running': True, 'public_ip': '13.124.201.58', 'user': 'ec2-user',
                     'id': 'i-0bb168b59ec98a524',
                     'group': 'woowa team', 'name': 'mha', 'key_file': '/Users/leejay/.ssh/hodolman.pem',
                     'type': 't2.micro',
                     'private_ip': '172.31.23.144'},
                ]
            },
